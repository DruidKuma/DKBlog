var blogApp = angular.module("blogApp", ['ngRoute', 'ui.bootstrap', 'ui.tinymce', 'ngCookies', 'pascalprecht.translate', 'ngTagsInput', 'dcbImgFallback', 'truncate', 'color.picker', 'ngFileUpload', 'dndLists']);
